  ...
  measurementId: "G-4J40FKKDNT"
        ...
        onValue(ref(db, 'properties'), (snapshot) => {
            ...
            document.getElementById('sidebar-count').innerText = totalCount;
        });
        ...
        // FIX: Safe Check added to avoid 'Cannot set properties of null'
        window.terminateFormEditMode = function() {
            ...
            document.getElementById('hero-preview-hook').innerHTML = "";
            ...
            // Safe innerText Assignment Check
            const textElement = document.getElementById('submit-btn-text');
            if (textElement) {
            ...
            document.getElementById('gallery-repeater-root').innerHTML = `
